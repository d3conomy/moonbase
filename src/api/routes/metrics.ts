 ...
 */
router.get('/logbooks', function(req: Request, res: Response) {
 ...
 */
router.get('/logbooks/:logbook', function(req: Request, res: Response) {
    const logbook = req.params.logbook;
    const items: number = req.query.items ? parseInt(req.query.items as string) : 10;
